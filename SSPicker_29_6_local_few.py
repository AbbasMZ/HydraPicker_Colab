...
def start():
    ...
    rand_6b7n = [231, 229, 234, 233, 235]
    rand_6b44 = [242, 239, 237, 241, 243]
    ...
    rand_5xnl = [283, 285, 290, 287, 284]
    rand_5w3s = [293, 298, 296, 294, 291, 292, 297, 295]
    rand_5w3l = [305, 300, 299, 301, 304]
    rand_5vy5 = [310, 307, 309]
    ...
    rand_4hhb = [343, 344, 342]
    rand_3j9i = [345, 347, 350, 346, 352, 351, 348, 349]
    rand_2wri = [356, 360, 354, 353, 359]
