...
def start():
    ...
    parser.add_argument('-dl', '--dest_list', type=str, default='labels6_4', dest='dest_list')
    parser.add_argument('-si', '--source_image', type=str, default='trainingdata6', dest='source_image')
    parser.add_argument('-di', '--dest_image', type=str, default='trainingdata6_2', dest='dest_image')
    ...
    with open("data/boxnet/labels6/" + 'uri_list5.pickle', 'rb') as handle:
    ...
    for c1 in range(range_start, range_end):
        ...
        if mode == 'image':
            ...
            #     target_blank = np.zeros((target_width, target_height), dtype=np.float32)
            ...
            target_blank[0: target_width, 0: target_height] = I
