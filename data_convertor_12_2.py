...
def start():
    ...
    parser.add_argument('-sl', '--source_list', type=str, default='labels12', dest='source_list')
    parser.add_argument('-dl', '--dest_list', type=str, default='labels12_2', dest='dest_list')
