...
class Learner():
    ...
    def save_cycle(self, name, cycle):
        ...
        torch.save(self.sched.layer_opt.opt.state_dict(),
                   os.path.join(self.models_path, f'{name}_cyc_{cycle}') + '_opt.h5')
    ...
    def fit_gen(self, model, data, layer_opt, n_cycle, cycle_len=None, cycle_mult=1, cycle_save_name=None, best_save_name=None,
                ...
                wds_sched_mult=None, use_swa=False, swa_start=1, swa_eval_freq=5, save_path='', **kwargs):
        ...
        if use_clr is not None:
            ...
            self.sched = CosAnneal(layer_opt, cycle_batches, on_cycle_end=cycle_end, cycle_mult=cycle_mult, save_path=save_path)
    ...
    def fit_opt_sched(self, phases, cycle_save_name=None, best_save_name=None, stop_div=False, data_list=None, callbacks=None, 
                      cut = None, use_swa=False, swa_start=1, swa_eval_freq=5, save_path='', **kwargs):
        ...
        self.sched = OptimScheduler(layer_opt, phases, len(self.data.trn_dl), stop_div, save_path=save_path)
