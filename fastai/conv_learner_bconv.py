...
class ConvnetBuilder():
    ...
    def __init__(self, f, c, is_multi, is_reg, ps=None, xtra_fc=None, xtra_cut=0, custom_head=None, pretrained=False, nfdef=None):
        ...
        aaa = 1 if 2<0 else 2 if 2>3 else 3
        self.nf = model_features[f] if f in model_features else (num_features(layers)*2 if (num_features(layers)*2) else (nfdef))
