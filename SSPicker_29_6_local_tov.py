...
def start():
    ...
    if mode == 'lrfind':
        ...
        if optimizer_type == 'adam':
            ...
            learn.fit(lr, epochs, cycle_len=cycle_len, particle=True,
                      best_save_name='SSPicker_' + version + '_' + training_type + '_' + save + 'best',
        ...
        uri_list_tst_dict = {"10077": [uri_list[i] for i in rand_10077[3:6]],
                             "10078": [uri_list[i] for i in rand_10078[3:6]],
                             "10081": [uri_list[i] for i in rand_10081[3:6]],
                             "pdb_6bqv": [uri_list[i] for i in rand_6bqv[2:4]],
                             "ss_1": [uri_list[i] for i in rand_ss_1[3:6]],
                             "pdb_6bhu": [uri_list[i] for i in rand_6bhu[2:4]],
                             "pdb_6bcx": [uri_list[i] for i in rand_6bcx[2:4]],
                             "pdb_6bcq": [uri_list[i] for i in rand_6bcq[2:4]],
                             "pdb_6bco": [uri_list[i] for i in rand_6bco[2:4]],
                             "pdb_6az1": [uri_list[i] for i in rand_6az1[2:4]],
                             "pdb_5y6p": [uri_list[i] for i in rand_5y6p[3:6]],
                             "pdb_5xwy": [uri_list[i] for i in rand_5xwy[2:4]],
                             "pdb_5w3s": [uri_list[i] for i in rand_5w3s[2:4]],
                             "pdb_5ngm": [uri_list[i] for i in rand_5ngm[2:4]],
                             "pdb_5mmi": [uri_list[i] for i in rand_5mmi[2:4]],
                             "pdb_5foj": [uri_list[i] for i in rand_5foj[1:2]],
                             "pdb_4zor": [uri_list[i] for i in rand_4zor[2:4]],
                             "pdb_3j9i": [uri_list[i] for i in rand_3j9i[2:4]],
                             "pdb_2gtl": [uri_list[i] for i in rand_2gtl[2:4]],
                             "pdb_1sa0": [uri_list[i] for i in rand_1sa0[2:4]],
                             "lf_1": [uri_list[i] for i in rand_lf_1[3:6]],
                             "hh_2": [uri_list[i] for i in rand_hh_2[3:6]],
                             "gk_1": [uri_list[i] for i in rand_gk_1[3:6]],
                             "10156": [uri_list[i] for i in rand_10156[3:6]],
                             "10153": [uri_list[i] for i in rand_10153[3:6]],
                             "10122": [uri_list[i] for i in rand_10122[3:6]],
                             "10097": [uri_list[i] for i in rand_10097[3:6]],
                             "10089": [uri_list[i] for i in rand_10089[3:6]],
                             "10084": [uri_list[i] for i in rand_10084[3:6]],
                             "10017": [uri_list[i] for i in rand_10017[3:6]],
                             "pdb_6b7n": [uri_list[i] for i in rand_6b7n[2:4]],
                             "pdb_6b44": [uri_list[i] for i in rand_6b44[2:4]],
                             "pdb_5xnl": [uri_list[i] for i in rand_5xnl[2:4]],
                             "pdb_5w3l": [uri_list[i] for i in rand_5w3l[2:4]],
                             "pdb_5vy5": [uri_list[i] for i in rand_5vy5[1:2]],
                             "pdb_4hhb": [uri_list[i] for i in rand_4hhb[1:2]],
                             "pdb_2wri": [uri_list[i] for i in rand_2wri[2:4]]}

        centroids_list_tst_dict = {"10077": [centroids_list[i] for i in rand_10077[3:6]],
                                   "10078": [centroids_list[i] for i in rand_10078[3:6]],
                                   "10081": [centroids_list[i] for i in rand_10081[3:6]],
                                   "pdb_6bqv": [centroids_list[i] for i in rand_6bqv[2:4]],
                                   "ss_1": [centroids_list[i] for i in rand_ss_1[3:6]],
                                   "pdb_6bhu": [centroids_list[i] for i in rand_6bhu[2:4]],
                                   "pdb_6bcx": [centroids_list[i] for i in rand_6bcx[2:4]],
                                   "pdb_6bcq": [centroids_list[i] for i in rand_6bcq[2:4]],
                                   "pdb_6bco": [centroids_list[i] for i in rand_6bco[2:4]],
                                   "pdb_6az1": [centroids_list[i] for i in rand_6az1[2:4]],
                                   "pdb_5y6p": [centroids_list[i] for i in rand_5y6p[3:6]],
                                   "pdb_5xwy": [centroids_list[i] for i in rand_5xwy[2:4]],
                                   "pdb_5w3s": [centroids_list[i] for i in rand_5w3s[2:4]],
                                   "pdb_5ngm": [centroids_list[i] for i in rand_5ngm[2:4]],
                                   "pdb_5mmi": [centroids_list[i] for i in rand_5mmi[2:4]],
                                   "pdb_5foj": [centroids_list[i] for i in rand_5foj[1:2]],
                                   "pdb_4zor": [centroids_list[i] for i in rand_4zor[2:4]],
                                   "pdb_3j9i": [centroids_list[i] for i in rand_3j9i[2:4]],
                                   "pdb_2gtl": [centroids_list[i] for i in rand_2gtl[2:4]],
                                   "pdb_1sa0": [centroids_list[i] for i in rand_1sa0[2:4]],
                                   "lf_1": [centroids_list[i] for i in rand_lf_1[3:6]],
                                   "hh_2": [centroids_list[i] for i in rand_hh_2[3:6]],
                                   "gk_1": [centroids_list[i] for i in rand_gk_1[3:6]],
                                   "10156": [centroids_list[i] for i in rand_10156[3:6]],
                                   "10153": [centroids_list[i] for i in rand_10153[3:6]],
                                   "10122": [centroids_list[i] for i in rand_10122[3:6]],
                                   "10097": [centroids_list[i] for i in rand_10097[3:6]],
                                   "10089": [centroids_list[i] for i in rand_10089[3:6]],
                                   "10084": [centroids_list[i] for i in rand_10084[3:6]],
                                   "10017": [centroids_list[i] for i in rand_10017[3:6]],
                                   "pdb_6b7n": [centroids_list[i] for i in rand_6b7n[2:4]],
                                   "pdb_6b44": [centroids_list[i] for i in rand_6b44[2:4]],
                                   "pdb_5xnl": [centroids_list[i] for i in rand_5xnl[2:4]],
                                   "pdb_5w3l": [centroids_list[i] for i in rand_5w3l[2:4]],
                                   "pdb_5vy5": [centroids_list[i] for i in rand_5vy5[1:2]],
                                   "pdb_4hhb": [centroids_list[i] for i in rand_4hhb[1:2]],
                                   "pdb_2wri": [centroids_list[i] for i in rand_2wri[2:4]]}
            ...
            with torch.no_grad():
                for val_counter in range(len(val_idxs)):
                    ...
                    if evaluate_format == "csv":
                        ...
                        # with open("data/boxnet/predictions/" + fnames_dict[val_counter] + "_BoxNet2Mask_20180918.star", "r") as text_file:
                        # with open("data/boxnet/predictions/" + fnames_dict[val_counter] + "_BoxNet_blank_trn5.star", "r") as text_file:
